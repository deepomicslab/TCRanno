...
repertoire_analysis.tcr2ept(tcr2tcr_output, outprefix, AO_map=AO_map, k=30, limit=1e-4)
repertoire_analysis.tcr2ag(tcr2tcr_output, outprefix, AO_map=AO_map, k=20, limit=1e-4)
repertoire_analysis.tcr2org(tcr2tcr_output, outprefix, AO_map=AO_map, k=10, limit=1e-4)
