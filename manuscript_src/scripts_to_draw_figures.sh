...
# figure 2
python3 fig2_all_tools_performance.py benchmark/TOTAL.cdr3s.txt benchmark/TOTAL_benchmark_set_filtered.pkl Total
python3 fig2_all_tools_performance.py benchmark/SARS2.cdr3s.txt benchmark/filtered_SARS2_for_test.pkl SARS-CoV2
