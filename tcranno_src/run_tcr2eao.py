...
if __name__ == '__main__':
    ...
    if is_tcr2tcr.startswith('T') or is_tcr2tcr.startswith('t'): #True, true
        ...
        core_analysis.tcr2tcr(infile, outprefix, encoder1, DB, DB_VDJ, AO_map, header=header, cdr3_aa_col=cdr3_aa_col, frequency=frequency, frequency_col=frequency_col, count=count, count_col=count_col, sep=sep, k=1, thread=t)
        if ept:
